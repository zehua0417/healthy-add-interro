...
> 此仓库复制来自[阿里云代码托管平台健康服务平台](https://codeup.aliyun.com/zero-one-star/zero-awei/zero-one-healthy-check/)中的c6-add-interro-vector分支, 此分支为我本人在该项目中的开发分支, 本人贡献了/healthy-cpp/healthy-c6-resultentry/目录下的代码.
